...
def launch_atividade_3_impl(context, *args, **kwargs):
    """
    Lança a atividade 3 em um terminal interativo (xterm), passando os parâmetros definidos no launch.
    """
    ...
    teleop_cmd = [
        ...
        (
            ...
            f'ros2 run custom_turtlesim atividade_3.py '
...
def generate_launch_description():
    ...
    launch_atividade_3_action = OpaqueFunction(function=launch_atividade_3_impl)
